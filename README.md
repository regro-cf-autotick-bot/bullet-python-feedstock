...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/bullet-python-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/bullet-python-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10816&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bullet-python-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.15.____cp315" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add bullet-python
# for installing globally
pixi global install bullet-python
```
...
It is possible to list all of the versions of `bullet-python` available on your platform:
...
```
pixi search bullet-python --channel conda-forge
```
